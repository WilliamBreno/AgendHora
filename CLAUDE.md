...
21. Agendamento com mais de um serviço: toggle na página pública, tabela `AgendamentoServico`, duração somada bloqueando a agenda como intervalo único, preço somado (ou "a combinar" se algum serviço não tiver preço), filtro de compatibilidade com serviços individuais, ranking do dashboard rateado por serviço
